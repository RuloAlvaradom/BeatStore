...
export default function Vinilos() {
  ...
  const productos = [
    { id: 58, name: "Pink Floyd - The Dark Side of the Moon", image: "img/coleccionables/vinilos1.jpg", price: 34990 },
    { id: 59, name: "Michael Jackson - Thriller", image: "img/coleccionables/vinilos2.jpg", price: 29900 },
    { id: 60, name: "The Beatles - Abbey Road", image: "img/coleccionables/vinilos3.jpg", price: 39990 },
  ];

  return (
    <Container className="my-5 text-center">
      <h1 className="mb-4">Vinilos (Discos de Colección)</h1>
      <Row>
        {productos.map((p) => (
